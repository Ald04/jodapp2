...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addEventListeners() {
        document.querySelectorAll('.select-entrada, input[id$="cantidad"], input[id$="precio_unitario"]').forEach(element => {
    ...
    document.querySelectorAll('select[id$="entrada"]').forEach(function(selectElement) {
