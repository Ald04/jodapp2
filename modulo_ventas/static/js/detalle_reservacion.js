...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addEventListeners() {
        document.querySelectorAll('.select-mesa, input[id$="cantidad"], input[id$="precio_unitario"]').forEach(element => {
    ...
    document.querySelectorAll('select[id$="id_detallereservacion_set-__prefix__-_reservacion"]').forEach(function(selectElement) {
